...
class gapGUI(QWidget):
	...
	def initUI(self):
		self.setWindowTitle('BLOCH gapGUI v2 (05.02.2019)')
		...
		tab1.form.addRow(QLabel("Photon energy:"),self.hvInput)
		...
		self.outputForm.addRow(QLabel("Photon energy:"),self.outputhv)
